...
class SensorUpdater:
    ...
    def update_reference(self, discovered: dict, existing: dict) -> dict:
        ...
        Args:
            discovered: The 4 dictionaries from _get_all_sensors_v11
    ...
    def _update_category(self, category: str, discovered: dict, existing: dict) -> dict:
        ...
        Args:
            ...
            discovered: Sensors discovered by _get_all_sensors_v11
...
async def run_update(args) -> int:
    ...
    try:
        ...
        # Call _get_all_sensors_v11
        print("Running _get_all_sensors_v11 to discover sensors...")
        await mocked.api._get_all_sensors_v11(
